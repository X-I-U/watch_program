...
typedef struct
{
	...
	lv_obj_t *screen_2_cont_9;
	lv_obj_t *screen_2_img_8;
	lv_obj_t *screen_2_cont_10;
	...
	lv_obj_t *screen_10_tileview_1;
	lv_obj_t *screen_10_tileview_1_tile;
	lv_obj_t *screen_10_cont_1;
	lv_obj_t *screen_10_img_1;
	lv_obj_t *screen_10_label_2;
	lv_obj_t *screen_10_cont_2;
	lv_obj_t *screen_10_img_2;
	lv_obj_t *screen_10_label_3;
	lv_obj_t *screen_10_cont_3;
	lv_obj_t *screen_10_img_4;
	lv_obj_t *screen_10_label_5;
	lv_obj_t *screen_10_cont_4;
	lv_obj_t *screen_10_img_3;
	lv_obj_t *screen_10_cont_5;
	lv_obj_t *screen_10_label_4;
	lv_obj_t *screen_10_cont_6;
	lv_obj_t *screen_10_cont_7;
	lv_obj_t *screen_10_cont_8;
	lv_obj_t *screen_10_label_8;
	lv_obj_t *screen_10_img_5;
	lv_obj_t *screen_10_label_6;
	lv_obj_t *screen_10_img_6;
	lv_obj_t *screen_10_label_7;
	lv_obj_t *screen_10_cont_9;
	lv_obj_t *screen_10_spinner_1;
	lv_obj_t *screen_10_label_9;
	lv_obj_t *screen_11;
	bool screen_11_del;
	lv_obj_t *screen_11_chart_1;
	lv_chart_series_t *screen_11_chart_1_0;
	lv_obj_t *screen_11_arc_1;
	lv_obj_t *screen_11_label_1;
	lv_obj_t *screen_11_label_2;
	lv_obj_t *screen_11_label_3;
	lv_obj_t *screen_11_label_4;
	lv_obj_t *screen_11_label_5;
	lv_obj_t *screen_11_label_6;
	lv_obj_t *screen_11_label_7;
	lv_obj_t *screen_11_label_8;
	lv_obj_t *screen_11_label_9;
	lv_obj_t *screen_11_label_10;
}lv_ui;
...
LV_IMG_DECLARE(_gaming3_alpha_34x33);
...
LV_IMG_DECLARE(_setting_alpha_36x33);
LV_IMG_DECLARE(_foot_alpha_32x31);
...
LV_IMG_DECLARE(_charging_alpha_20x19);
LV_IMG_DECLARE(_back_alpha_45x40);
LV_IMG_DECLARE(_back_alpha_37x31);
LV_IMG_DECLARE(_stop_alpha_35x37);
LV_IMG_DECLARE(_start_alpha_47x35);
LV_IMG_DECLARE(_cancel_alpha_41x38);
LV_IMG_DECLARE(_retry_alpha_41x37);
LV_IMG_DECLARE(_stop_alpha_36x33);
LV_IMG_DECLARE(_start_alpha_42x34);
LV_IMG_DECLARE(_timer2_alpha_41x36);
LV_IMG_DECLARE(_back_alpha_37x34);
LV_IMG_DECLARE(_clock7_alpha_52x49);
...
LV_IMG_DECLARE(_music10_alpha_110x109);
...
LV_IMG_DECLARE(_wifi_alpha_39x38);
LV_IMG_DECLARE(_about_alpha_37x36);
LV_IMG_DECLARE(_time_check_alpha_38x38);
LV_IMG_DECLARE(_back_alpha_37x30);
LV_IMG_DECLARE(_back_alpha_37x33);
LV_IMG_DECLARE(_3fc8047fe15e4c80bda6a5500837f8d6_alpha_53x54);

...
void setup_scr_screen_6(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->screen_6_tileview_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_6_tileview_1, lv_color_hex(0x334662), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_6_cont_1, lv_color_hex(0xc0d8f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_6_cont_1, LV_GRAD_DIR_HOR, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen_6_cont_1, lv_color_hex(0xc8fa50), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui->screen_6_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui->screen_6_cont_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_6_cont_2, lv_color_hex(0xc0d8f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_6_cont_2, LV_GRAD_DIR_HOR, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen_6_cont_2, lv_color_hex(0xc8fa50), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui->screen_6_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui->screen_6_cont_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes screen_6_cont_3
    ui->screen_6_cont_3 = lv_obj_create(ui->screen_6_tileview_1_tile);
    lv_obj_set_pos(ui->screen_6_cont_3, 11, 153);
    lv_obj_set_size(ui->screen_6_cont_3, 220, 59);
    lv_obj_set_scrollbar_mode(ui->screen_6_cont_3, LV_SCROLLBAR_MODE_OFF);

    //Write style for screen_6_cont_3, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_6_cont_3, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_6_cont_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_6_cont_3, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_6_cont_3, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_6_cont_3, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_6_cont_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_6_cont_3, lv_color_hex(0xc0d8f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_6_cont_3, LV_GRAD_DIR_HOR, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen_6_cont_3, lv_color_hex(0xc8fa50), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui->screen_6_cont_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui->screen_6_cont_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_6_cont_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_6_cont_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_6_cont_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_6_cont_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_6_cont_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_6_label_4
    ui->screen_6_label_4 = lv_label_create(ui->screen_6_cont_3);
    lv_label_set_text(ui->screen_6_label_4, "稻香——翻自周杰伦                             ");
    lv_label_set_long_mode(ui->screen_6_label_4, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_6_label_4, 23, 13);
    lv_obj_set_size(ui->screen_6_label_4, 180, 28);
    ...
    lv_obj_set_style_text_font(ui->screen_6_label_4, &lv_font_SourceHanSansSC_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes screen_6_cont_4
    ui->screen_6_cont_4 = lv_obj_create(ui->screen_6_tileview_1_tile);
    lv_obj_set_pos(ui->screen_6_cont_4, 11, 225);
    lv_obj_set_size(ui->screen_6_cont_4, 220, 59);
    lv_obj_set_scrollbar_mode(ui->screen_6_cont_4, LV_SCROLLBAR_MODE_OFF);

    //Write style for screen_6_cont_4, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_6_cont_4, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_6_cont_4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_6_cont_4, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_6_cont_4, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_6_cont_4, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_6_cont_4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_6_cont_4, lv_color_hex(0xc0d8f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_6_cont_4, LV_GRAD_DIR_HOR, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen_6_cont_4, lv_color_hex(0xc8fa50), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui->screen_6_cont_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui->screen_6_cont_4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_6_cont_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_6_cont_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_6_cont_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_6_cont_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_6_cont_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_6_label_5
    ui->screen_6_label_5 = lv_label_create(ui->screen_6_cont_4);
    lv_label_set_text(ui->screen_6_label_5, "反方向的钟——翻自周杰伦                             ");
    lv_label_set_long_mode(ui->screen_6_label_5, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_6_label_5, 18, 6);
    lv_obj_set_size(ui->screen_6_label_5, 180, 41);
    ...
    lv_obj_set_style_text_font(ui->screen_6_label_5, &lv_font_SourceHanSansSC_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes screen_6_cont_5
    ui->screen_6_cont_5 = lv_obj_create(ui->screen_6_tileview_1_tile);
    lv_obj_set_pos(ui->screen_6_cont_5, 11, 297);
    lv_obj_set_size(ui->screen_6_cont_5, 220, 59);
    lv_obj_set_scrollbar_mode(ui->screen_6_cont_5, LV_SCROLLBAR_MODE_OFF);

    //Write style for screen_6_cont_5, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_6_cont_5, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_6_cont_5, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_6_cont_5, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_6_cont_5, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_6_cont_5, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_6_cont_5, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_6_cont_5, lv_color_hex(0xc0d8f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_6_cont_5, LV_GRAD_DIR_HOR, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen_6_cont_5, lv_color_hex(0xc8fa50), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui->screen_6_cont_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui->screen_6_cont_5, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_6_cont_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_6_cont_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_6_cont_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_6_cont_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_6_cont_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_6_label_6
    ui->screen_6_label_6 = lv_label_create(ui->screen_6_cont_5);
    lv_label_set_text(ui->screen_6_label_6, "绿色——翻自陈雪凝                       ");
    lv_label_set_long_mode(ui->screen_6_label_6, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_6_label_6, 22, 12);
    lv_obj_set_size(ui->screen_6_label_6, 180, 33);
    ...
    lv_obj_set_style_text_font(ui->screen_6_label_6, &lv_font_SourceHanSansSC_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes screen_6_cont_6
    ui->screen_6_cont_6 = lv_obj_create(ui->screen_6_tileview_1_tile);
    lv_obj_set_pos(ui->screen_6_cont_6, 11, 369);
    lv_obj_set_size(ui->screen_6_cont_6, 220, 59);
    lv_obj_set_scrollbar_mode(ui->screen_6_cont_6, LV_SCROLLBAR_MODE_OFF);

    //Write style for screen_6_cont_6, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_6_cont_6, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_6_cont_6, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_6_cont_6, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_6_cont_6, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_6_cont_6, 20, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_6_cont_6, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_6_cont_6, lv_color_hex(0xc0d8f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_6_cont_6, LV_GRAD_DIR_HOR, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen_6_cont_6, lv_color_hex(0xc8fa50), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui->screen_6_cont_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui->screen_6_cont_6, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_6_cont_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_6_cont_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_6_cont_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_6_cont_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_6_cont_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_6_label_7
    ui->screen_6_label_7 = lv_label_create(ui->screen_6_cont_6);
    lv_label_set_text(ui->screen_6_label_7, "泡沫——翻自邓紫棋                            ");
    lv_label_set_long_mode(ui->screen_6_label_7, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_6_label_7, 22, 16);
    lv_obj_set_size(ui->screen_6_label_7, 180, 22);
    ...
    lv_obj_set_style_text_color(ui->screen_6_label_7, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_6_label_7, &lv_font_SourceHanSansSC_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);

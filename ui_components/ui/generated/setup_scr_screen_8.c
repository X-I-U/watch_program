...
void setup_scr_screen_8(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_8, 240, 300);
    ...
    lv_obj_set_style_bg_color(ui->screen_8, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_8_label_1, "星期一二三四五六日");
    lv_label_set_long_mode(ui->screen_8_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_8_label_1, 28, 40);
    lv_obj_set_size(ui->screen_8_label_1, 185, 34);
    ...
    lv_obj_set_style_text_font(ui->screen_8_label_1, &lv_font_SourceHanSansSC_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_8_label_2, "一二三四五六七八九十十一十二月");
    lv_label_set_long_mode(ui->screen_8_label_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_8_label_2, 9, 88);
    lv_obj_set_size(ui->screen_8_label_2, 217, 49);
    ...
    lv_obj_set_style_text_font(ui->screen_8_label_2, &lv_font_SourceHanSansSC_Regular_20, LV_PART_MAIN|LV_STATE_DEFAULT);

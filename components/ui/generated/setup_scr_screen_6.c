...
void setup_scr_screen_6(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen_6, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->screen_6_img_2, &_clock_alpha_100x100);
    lv_img_set_pivot(ui->screen_6_img_2, 50,50);
    lv_img_set_angle(ui->screen_6_img_2, 0);
    lv_obj_set_pos(ui->screen_6_img_2, 79, 94);
    lv_obj_set_size(ui->screen_6_img_2, 100, 100);

    //Write style for screen_6_img_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->screen_6_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

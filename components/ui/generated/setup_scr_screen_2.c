...
void setup_scr_screen_2(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_2_tileview_1, 0, 170);
    lv_obj_set_size(ui->screen_2_tileview_1, 240, 100);
    ...
    lv_obj_set_pos(ui->screen_2_cont_1, 3, 43);
    ...
    lv_obj_set_pos(ui->screen_2_cont_2, 243, 42);
    ...
    lv_obj_set_pos(ui->screen_2_cont_4, 314, 11);
    ...
    lv_obj_set_pos(ui->screen_2_cont_3, 75, 8);
    ...
    lv_obj_set_pos(ui->screen_2_cont_5, 121, 45);
    ...
    lv_obj_set_pos(ui->screen_2_cont_6, 180, 6);
